        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-50">
            {events.map((e: (typeof events)[number]) => {
              const totalSold = e.ticketTypes.reduce((s: number, t: (typeof e.ticketTypes)[number]) => s + t.sold, 0);
              const totalCapacity = e.ticketTypes.reduce((s: number, t: (typeof e.ticketTypes)[number]) => s + t.capacity, 0);
              return (
